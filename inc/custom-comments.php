...
// Comments form.
add_filter( 'comment_form_default_fields', 'understrap_bootstrap_comment_form_fields_child' );
 ...
 * @return array
 */
function understrap_bootstrap_comment_form_fields_child( $fields ) {
...
add_filter( 'comment_form_defaults', 'understrap_bootstrap_comment_form_child', 15,1 );
 ...
 * @return mixed
 */
function understrap_bootstrap_comment_form_child( $args ) {
    $args['comment_field'] = '<div class="form-group comment-form-comment">
    <label for="comment">' . _x( 'Comment', 'noun', 'understrap' ) . ( ' <span class="required">*</span>' ) . '</label>
    <textarea class="form-control" id="comment" name="comment" aria-required="true" cols="45" rows="8"></textarea>
    </div>';
    $args['class_submit']  = 'btn btn-primary font-weight-semi-bold box-shadow'; // since WP 4.1.
    return $args;
}
