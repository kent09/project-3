...
if (! class_exists ( 'understrap_WP_Bootstrap_Navwalker_child' )) :
     ...
     */
    class understrap_WP_Bootstrap_Navwalker_child extends Walker_Nav_Menu {
        /**
            ...
            if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
                ...
                */
                ...
                if ( $args->has_children && $depth === 0 ) {
                    ...
                    $atts['data-url']    = wp_is_mobile() ? '#' : $item->url;
                } else {
