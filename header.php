...
<div class="hfeed site" id="page">
    ...
    <?php if(!empty($banner_id) && !is_front_page()): ?>
    ...
    <?php if( is_front_page() || $banner_same_hp == true):
        $pageID = get_option('page_on_front');
        $carousel = get_field('carousel', $pageID );
    ?>

        <div class="home-slider default_cg_banner">
            <div class="owl-carousel owl-theme">
                <?php if($carousel){
                    foreach($carousel as $item){
                    $bg = wp_is_mobile() ? $item['mobile_bg'] : $item['background'];
                ?>
                    <div class="item" style="background-image: url(<?php echo $bg; ?>);" data-full="<?php echo $item['background']; ?>" data-mobile="<?php echo $item['mobile_bg']; ?>">
                        <div class="container">
                            <div class="content">
                                <?php if($item['title']): ?>
                                    <div class="title viva_beautiful_caps"><?php echo $item['title']; ?></div>
                                <?php endif; ?>
                                <?php if($item['content']): ?>
